import { Errors, type BrokerOptions } from "moleculer";
...
class JoiValidator extends Validator {
    ...
    compile(schema: Joi.Schema) {
        return (params: any) => this.validate(params, schema);
    }

    validate(params: any, schema: Joi.Schema) {
...
const config: BrokerOptions = {
    ...
    retryPolicy: {
        ...
        check: err => err && err instanceof Errors.MoleculerRetryableError && !!err.retryable
    },
    ...
    circuitBreaker: {
        ...
        // A function to check failed requests.
        check: err => err && err instanceof Errors.MoleculerError &&err.code >= 500
    },
